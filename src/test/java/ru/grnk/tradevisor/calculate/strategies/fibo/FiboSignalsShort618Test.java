...
class FiboSignalsShort618Test {
     ...
     */
    @Test
    void getFiboSignals_618_short_2_touches() {
        // Arrange
        float[] lows = {
                // рост 0‑100%
                80f,81f,82f,83f,84f,85f,86f,87f,88f,89f, 90f,91f,92f,93f,94f,95f,96f,97f,98f,99f,
                // откат до 38.2% (≈ 87.64)
                99f,98f,97f,96f,95f,94.7f,94.8f,94.9f,94.5f,88.022f, // touch-2
                // отскок
                95f,96f,96f,97f,97f,96f,97f,98f,97f,97f,
                // откат до 38.2% (≈ 87.64)
                99f,98f,97f,96f,95f,94.7f,94.8f,94.9f,94.5f,88.022f, // touch-1
                // отскок
                95f,96f,96f,97f,97f,96f,97f,98f,97f,97f
        };
        float[] highs = {
        ...
        assertThat(df.format(resultParams.priceOpen())).isEqualTo(df.format(92.978f));
    ...
    public void levelBreakdownGap_taskRegistrationGap_levels_no_break_test() {
            ...
            float[] lows = {
                    ...
                    80f,81f,82f,83f,84f,85f,86f,87f,88f,89f, 90f,91f,92f,93f,94f,95f,96f,97f,98f,99f,
                    // откат до 38.2% (≈ 87.64)
                    99f,98f,97f,96f,95f,94.7f,94.8f,94.9f,94.5f,(88.022f - 0.20f), // touch-2 level breakdown ok.
                    // отскок
                    95f,96f,96f,97f,97f,96f,97f,98f,97f,97f,
                    // откат до 38.2% (≈ 87.64)
                    99f,98f,97f,96f,95f,94.7f,94.8f,94.9f,94.5f,(88.022f + 0.62f), // touch-1 touch registration ok.
                    // отскок
                    95f,96f,96f,97f,97f,96f,97f,98f,97f,97f
            };
            float[] highs = {
    ...
    public void touchRegisterGap_failed_no_signal_test() {
        ...
        float[] lows = {
                ...
                95f,96f,96f,97f,97f,96f,97f,98f,97f,97f,
                // откат до 38.2% (≈ 87.64)
                99f,98f,97f,96f,95f,94.7f,94.8f,94.9f,94.5f,(88.022f + 0.64f), // touch-1 no touch. registration failed.
                // отскок
                95f,96f,96f,97f,97f,96f,97f,98f,97f,97f
        };
        float[] highs = {
    ...
    public void levelBreakDown_no_signal_test() {
        ...
        float[] lows = {
                ...
                80f,81f,82f,83f,84f,85f,86f,87f,88f,89f, 90f,91f,92f,93f,94f,95f,96f,97f,98f,99f,
                // откат до 38.2% (≈ 87.64)
                99f,98f,97f,96f,95f,94.7f,94.8f,94.9f,94.5f,(88.022f - 0.22f), // touch-2 level breakdown. no signal.
                // отскок
                95f,96f,96f,97f,97f,96f,97f,98f,97f,97f,
                // откат до 38.2% (≈ 87.64)
                99f,98f,97f,96f,95f,94.7f,94.8f,94.9f,94.5f,(88.022f + 0.62f), // touch-1 touch registration ok.
