...
public class AccountInfoCmdHandlerImpl implements TgMessageHandler {
    ...
    public void handle(Message message) {
        telegramApiClient.sendMessage(sendSimpleMessage(message.getChatId(), "пользователь запросил информацию об аккаунте"));
    }
}
