...
public class StatsCmdHandlerImpl implements TgMessageHandler {
    ...
    public void handle(Message message) {
        telegramApiClient.sendMessage(sendSimpleMessage(message.getChatId(), "пользователь запросил статистику"));
    }
}
