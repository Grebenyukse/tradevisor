        ...
        return ChartDto.builder()
                ...
                .options(ChartDto.ChartOptions.builder()
                        .scales(ChartDto.ChartOptions.ChartScales.builder()
                                ...
                                .build())
                        .build())
                .plugins(List.of(ChartDto.ChartPlugins.builder()
                        .legend(ChartDto.ChartPlugins.Legend.builder()
                                .display(false)
                                .build())
                        .title(ChartDto.ChartPlugins.Title.builder()
                                .text(plotRecord.ticker())
                                .font(ChartDto.ChartPlugins.Title.Font.builder()
                                        .size(20)
                                        .build())
                                .display(true)
                                .build())
